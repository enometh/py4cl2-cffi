...
(defvar *py-output-stream-pipe*
  (format nil "/tmp/py4cl2-cffi-output-~D" (swank-compat-backend:getpid)))
(defvar *py-error-output-stream-pipe*
  (format nil "/tmp/py4cl2-cffi-error-output-~D" (swank-compat-backend:getpid)))
